...
## [1.3.0](https://github.com/x1-labs/squads-v4-ui/compare/v1.2.3...v1.3.0) (2026-09-03)
...
* add extend program option to program manager ([95f3f3e](https://github.com/x1-labs/squads-v4-ui/commit/95f3f3e87e9a9a3c427cabb5bd3cd1256cd2367c))
...
* decode and summarize delegation program instructions ([#19](https://github.com/x1-labs/squads-v4-ui/issues/19)) ([7ef1d5e](https://github.com/x1-labs/squads-v4-ui/commit/7ef1d5e4fb3e388fda0f006426853b22eb026b4f))
* decode and summarize warp bridge instructions ([#20](https://github.com/x1-labs/squads-v4-ui/issues/20)) ([bd9959e](https://github.com/x1-labs/squads-v4-ui/commit/bd9959efebc094057d0529d7c329ad58f7bfc2fb))
* decode the delegation repeat-removal penalty ([#21](https://github.com/x1-labs/squads-v4-ui/issues/21)) ([e5b17d9](https://github.com/x1-labs/squads-v4-ui/commit/e5b17d939428b923faca719ef7c1c47fb39ff779))
...
* resolve the native token symbol per network ([#23](https://github.com/x1-labs/squads-v4-ui/issues/23)) ([6999421](https://github.com/x1-labs/squads-v4-ui/commit/6999421ff088b36ba796265f2fad3fd76e1a9c08))
...
* support per-network env files and namespace settings by network ([#13](https://github.com/x1-labs/squads-v4-ui/issues/13)) ([5ff09f4](https://github.com/x1-labs/squads-v4-ui/commit/5ff09f49ff8fb4b45e79d235ea39b7e9d30c3df5))
...
* close inactive stake accounts on withdraw instead of stranding rent ([#17](https://github.com/x1-labs/squads-v4-ui/issues/17)) ([feda2ce](https://github.com/x1-labs/squads-v4-ui/commit/feda2ce34d22f097f047aa9be068a16d5b7a17d9))
...
* keep the execute dialog open when its inputs are clicked ([#26](https://github.com/x1-labs/squads-v4-ui/issues/26)) ([2ab359f](https://github.com/x1-labs/squads-v4-ui/commit/2ab359f8f90ec955742ab20235991ba9122f65d0))
...
* re-check network identity, plus two send-path cleanups ([#28](https://github.com/x1-labs/squads-v4-ui/issues/28)) ([dbb0cc4](https://github.com/x1-labs/squads-v4-ui/commit/dbb0cc496b507d2562d1392c79d309a6fb405495))
* rebroadcast transactions until the blockhash expires ([#24](https://github.com/x1-labs/squads-v4-ui/issues/24)) ([f5ab7ed](https://github.com/x1-labs/squads-v4-ui/commit/f5ab7ed9b514a5e435f8c39fa70c81828e239989))
...
* require upgrade authority signature for program extend ([5f8e76d](https://github.com/x1-labs/squads-v4-ui/commit/5f8e76d81c003624d238b75cbb0870ef1515006d))
...
* round the removal count up, matching strike_tier on-chain ([#22](https://github.com/x1-labs/squads-v4-ui/issues/22)) ([242ad1e](https://github.com/x1-labs/squads-v4-ui/commit/242ad1e37a78d72af6d4814d80ec40035b6ae58b))
* send extend program directly from wallet instead of via multisig ([c9466be](https://github.com/x1-labs/squads-v4-ui/commit/c9466be64900e6c59c05c30c3c00d1304bff7f00))
...
* silently reconnect wallet on tab focus after lock ([#18](https://github.com/x1-labs/squads-v4-ui/issues/18)) ([cbd671b](https://github.com/x1-labs/squads-v4-ui/commit/cbd671b2f4c1c2e8bba595b2e6621a56d6dc862e))
* stabilize wallet connection and use sign-only tx flow ([#12](https://github.com/x1-labs/squads-v4-ui/issues/12)) ([5ec0504](https://github.com/x1-labs/squads-v4-ui/commit/5ec05040c58afb9ba3a651cbf5a4ca12fbacd0f3))
* stop a Solana RPC URL resolving to X1 Mainnet ([#29](https://github.com/x1-labs/squads-v4-ui/issues/29)) ([60c2a1f](https://github.com/x1-labs/squads-v4-ui/commit/60c2a1fc44c639c4b45dfbb8a205db206516b5bb))
...
* treat deactivated genesis stakes as inactive and guard batch unstake ([#15](https://github.com/x1-labs/squads-v4-ui/issues/15)) ([d80946f](https://github.com/x1-labs/squads-v4-ui/commit/d80946f116761c9c02980ef8e791a3602874aef4))
...
* validate buffer authority matches vault before program upgrade proposal ([0636244](https://github.com/x1-labs/squads-v4-ui/commit/0636244645f8f8452dd7affa7e2f086339eea181))
...
* withdraw stakes minus rent reserve to avoid close during cooldown ([#16](https://github.com/x1-labs/squads-v4-ui/issues/16)) ([8b22940](https://github.com/x1-labs/squads-v4-ui/commit/8b229403cdbf12acc982c5a7dd095d2522e130bf))
