...
/**
 * Summary component for native token transfers
...
export const XntTransferSummary: React.FC<InstructionSummaryProps> = ({ instruction }) => {
  ...
  if (instruction.data) {
    ...
    // For native transfers, the simpleDecoder sets: { from, to, lamports }
  ...
  return (
    <div className="space-y-2 text-sm">
      <div className="font-semibold text-blue-600 dark:text-blue-400">{nativeSymbol} Transfer</div>
