    ...
    <main>
      <div className="space-y-6">
        ...
        <div className="border-b border-border pb-4">
          <h1 className="text-3xl font-bold mb-3">Squad Overview</h1>
          {multisigAddress && (
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-sm text-muted-foreground">Address:</span>
              <div className="flex items-center gap-2 bg-muted/50 rounded-lg px-3 py-1.5">
                <code className="text-sm font-mono text-foreground break-all lg:break-normal">
                  <span className="hidden lg:inline">{multisigAddress}</span>
                  <span className="lg:hidden">{multisigAddress.slice(0, 8)}...{multisigAddress.slice(-8)}</span>
                </code>
                <button
